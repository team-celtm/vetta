...
export async function POST(req: NextRequest) {
  try {
    ...
    //    NOTE: Your schema doesn't have a password_hash column yet.
    //    Run this migration in pgAdmin before using this route:
    //
    ...
    // Set JWT as an HttpOnly cookie (more secure than localStorage)
