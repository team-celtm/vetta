  ...
  <div className="flex min-h-screen w-full flex-col lg:flex-row font-sans">
    ...
    <div className="flex flex-1 flex-col justify-center bg-[#F5F2EC] px-5 sm:px-8 md:px-12 lg:px-16 py-10">
      ...
      >
          ...
          {(field) => (
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm focus:ring-2 focus:ring-[#1A35E8]/20"
              />
            </div>
          )}
        </form.Field>
        ...
        <button
          type="submit"
          className="mt-2 w-full rounded-xl bg-[#1A35E8] px-6 py-3 md:py-4 text-sm font-bold text-white hover:bg-[#1530cc] cursor-pointer"
        >
          Sign In →
        </button>
      </form>
